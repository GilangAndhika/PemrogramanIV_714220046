                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        setState(() {
                          _controllerDate.text = DateFormat('dd-MM-yyyy').format(pickedDate);
                        });
                      }
                    },
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            backgroundImage: data['webFileBytes'] != null
                                ? MemoryImage(data['webFileBytes'])
                                    as ImageProvider
                            ...
                            children: [
                              ...
                              ClipRRect(
                                ...
                                child: LinearProgressIndicator(
                                  value: 1.0,
                                  color: data['color'],
                                  backgroundColor: data['color'].withOpacity(0.3),
                                  minHeight: 8,
                                ),
                              ),
                            ],
...
//validation phone
  String? _validatePhone(String? value) {
    ...
    if (value.length < 8 || value.length > 14) {
      return 'Nomor telepon harus memiliki panjang antara 8 hingga 14 digit';
    }
  ...
  // File Picker Method
    ...
    if (result != null) {
      ...
      setState(() {
        _webFileBytes = file.bytes; // Simpan byte gambar
  ...
  void _addData() {
    ...
    setState(() {
      if (editedData != null) {
        ...
        editedData!['webFileBytes'] = data['webFileBytes'];
        editedData = null;
      } else {
